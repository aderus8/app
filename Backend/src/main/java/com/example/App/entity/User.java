...
@NamedQuery(name = "User.getAllUser", query = "select new com.example.App.wrapper.UserWrapper(u.id,u.name,u.email,u.contactNumber,u.status) from User u where u.role='user'")
